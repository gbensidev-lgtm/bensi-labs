...
export function ProjectContext({ documents }: { documents: ProjectDocument[] }) {
  if (!documents.length) {
    return (
  ...
  return (
    <section className="mt-12">
      ...
      <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted">
        Documentação interna do Studio. Fonte de verdade para o desenvolvimento — não pertence ao site público.
      </p>
